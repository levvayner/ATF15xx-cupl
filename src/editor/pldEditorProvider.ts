...
export class PldEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private static readonly viewType = 'ATF15xx-cupl.pldEditor';
	...
	private addNewScratch(document: vscode.TextDocument) {
		...
		const character = PldEditorProvider.scratchCharacters[Math.floor(Math.random() * PldEditorProvider.scratchCharacters.length)];
		json.scratches = [
